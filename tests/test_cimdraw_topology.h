...
class TestCimdrawTopology : public QObject
{
    Q_OBJECT
...
private slots:
    ...
    void topology_query_reports_runtime_projection_info();
    void runtime_power_queries_use_unified_topology_projection();
    void topology_query_reports_relation_node_info();
    ...
    void connect_line_exposes_resolved_relation_edge_meta();
    void connect_line_exposes_relation_edge_lookup_hint();
    void connect_line_loads_persisted_topology_binding_snapshot();
    void connect_line_restores_persisted_endpoint_items_from_binding_index();
    void connect_line_applies_relation_edge_meta();
    void connect_line_duplicate_detaches_topology_identity();
    void connect_line_port_setters_refresh_topology_binding();
    void connect_line_xml_roundtrip_preserves_topology_binding_snapshot();
    ...
    void cim_query_facade_locates_scene_item_and_mrid();
    void cim_query_facade_returns_minimal_behavior_result();
    void cim_query_facade_exposes_graphic_render_state();
    void cim_graphic_render_state_query_reads_effective_visual_state();
    void cim_graphic_render_state_query_resolves_mrid_and_selection();
    void cim_graphic_behavior_query_reads_mrid_selection_and_wiring_results();
    void cim_graphic_visual_summary_query_builds_live_summary();
    void cim_generated_topology_graph_query_builds_source_relation_and_graph_summaries();
    void cim_topology_summary_query_builds_object_highlight_and_summary_lines();
    void cim_power_topology_runtime_query_reads_projection_snapshot_document_and_paths();
    void cim_power_topology_preview_query_builds_switch_protection_and_operation_previews();
    void cim_topology_compat_query_reads_relation_and_binding_queries();
    void cim_query_facade_exposes_selected_graphic_summary_and_browser_sync();
    void cim_graphic_summary_text_formats_status_labels();
    void scene_wiring_data_behavior_payload_refreshes_wiring_item();
    void scene_behavior_result_api_exposes_explicit_behavior_payload();
    void cim_query_facade_forwards_power_topology_queries();
    void cim_query_facade_exposes_runtime_power_projection();
    void cim_query_facade_builds_generated_topology_source_summary();
    void cim_query_facade_builds_generated_topology_graph_summary();
    void cim_query_facade_builds_generated_topology_relation_summary();
    void cim_query_facade_reverses_generated_topology_relation_ports_and_arrows();
    void cim_query_facade_derives_generated_topology_arrows_from_flow_sign();
    void cim_query_facade_resolves_relation_edge_info();
    void cim_query_facade_builds_topology_object_summary();
    void cim_query_facade_builds_topology_highlight_summary();
    void cim_query_facade_builds_topology_summary_lines();
    void scene_renders_generated_topology_graph_summary();
    ...
    void frame_topology_controller_generates_relation_edges_from_relation_snapshot();
    void cim_model_browser_dock_status_column_uses_render_state_summary();
    ...
    void cimdraw_tool_box_manager_exposes_default_sidebar_pages();
    void cimdraw_item_controller_tracks_view_and_object();
    void cimdraw_image_manager_exposes_widget();
    ...
    void power_topology_analysis_controller_preview_queries_share_facade_path();
    ...
    void cimdraw_file_load_by_xml_rebinds_connect_lines_via_topology_binding_index();
    void cimdraw_mime_data_instantiate_paste_batch_rebinds_connect_lines_via_topology_binding_index();
