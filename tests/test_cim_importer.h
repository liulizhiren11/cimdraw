...
private slots:
    ...
    void topology_mapper_builds_minimal_snapshot_from_cim_model();
    void importer_exposes_model_topology_snapshot();
    void importer_topology_projection_uses_unified_query_entry();
};
