...
#include "wiring/power/LzPowerEssItem.h"
#include "wiring/power/LzPowerFuseItem.h"
#include "wiring/power/LzPowerGeneratorItem.h"
#include "wiring/power/LzPowerGridItem.h"
#include "wiring/power/LzPowerJunctionItem.h"
#include "wiring/power/LzPowerArcCoilItem.h"
#include "wiring/power/LzPowerAutoXfmrItem.h"
#include "wiring/power/LzPowerEarthingXfmrItem.h"
#include "wiring/power/LzPowerLoadItem.h"
#include "wiring/power/LzPowerPvInfeedItem.h"
#include "wiring/power/LzPowerSplitReactorItem.h"
#include "wiring/power/LzPowerSvgCompItem.h"
#include "wiring/power/LzPowerReactorItem.h"
#include "wiring/power/LzPowerStationXfmrItem.h"
#include "wiring/power/LzPowerTransformer2wItem.h"
#include "wiring/power/LzPowerTransformer3wItem.h"
#include "wiring/power/LzPowerVoltageTransformerItem.h"
#include "wiring/power/LzPowerWindInfeedItem.h"
...
LzConnectLine* findGeneratedHelperLineBetween(LzScene& scene, QGraphicsItem* first, QGraphicsItem* second)
{
...
LzConnectPoint* linePortOnItem(LzConnectLine* line, QGraphicsItem* item)
{
    if (!line || !item)
        return nullptr;
...
QPointF rotatedSceneDirectionForPort(LzConnectPoint* port)
{
    if (!port)
        return {};
...
QPointF firstDistinctStepDirectionFromItem(LzConnectLine* line, QGraphicsItem* item)
{
    if (!line || !item)
        return {};
...
QPointF sceneCenterForPort(LzConnectPoint* port)
{
    if (!port)
        return {};
...
void assertPortDirectionOnItem(LzConnectLine* line, QGraphicsItem* item, CONNECT_DIRECTION expectedDirection)
{
    QVERIFY(line != nullptr);
    LzConnectPoint* port = linePortOnItem(line, item);
    QVERIFY(port != nullptr);
    QCOMPARE(port->getDirection(), expectedDirection);
}

void assertLineExitsItemAlongRotatedPortNormal(LzConnectLine* line,
                                               QGraphicsItem* item,
...
void TestCimGraphics::tool_manager_registers_missing_graphics()
{
    ...
    LzPowerJunctionItem junction(QRectF(0, 0, 28, 28));
    ...
    QCOMPARE(mapper.drawTypeForObject(connector), LZ_WSYM_JUNCTION);
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:Fuse rdf:about="#fuse-001"/>
    ...
    QVERIFY(dynamic_cast<LzPowerCurrentTransformerItem*>(buildResult.shapeByMrid.value(QStringLiteral("ct-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerVoltageTransformerItem*>(buildResult.shapeByMrid.value(QStringLiteral("pt-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerVoltageTransformerItem*>(buildResult.shapeByMrid.value(QStringLiteral("vt-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerFuseItem*>(buildResult.shapeByMrid.value(QStringLiteral("fuse-001"))) != nullptr);
}
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:Terminal rdf:ID="terminal-battery-001">
    ...
    QVERIFY(dynamic_cast<LzPowerPvInfeedItem*>(buildResult.shapeByMrid.value(QStringLiteral("solar-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerWindInfeedItem*>(buildResult.shapeByMrid.value(QStringLiteral("wind-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerEssItem*>(buildResult.shapeByMrid.value(QStringLiteral("battery-001"))) != nullptr);
}
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:DiagramObjectPoint rdf:ID="diagram-battery-layout-001-p1">
    ...
    auto* solar =
        dynamic_cast<LzPowerPvInfeedItem*>(buildResult.shapeByMrid.value(QStringLiteral("solar-layout-001")));
    auto* wind =
        dynamic_cast<LzPowerWindInfeedItem*>(buildResult.shapeByMrid.value(QStringLiteral("wind-layout-001")));
    auto* battery =
        dynamic_cast<LzPowerEssItem*>(buildResult.shapeByMrid.value(QStringLiteral("battery-layout-001")));
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:Terminal rdf:ID="terminal-equivalent-001">
    ...
    QVERIFY(dynamic_cast<LzPowerGeneratorItem*>(buildResult.shapeByMrid.value(QStringLiteral("generator-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerGridItem*>(buildResult.shapeByMrid.value(QStringLiteral("external-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerGridItem*>(buildResult.shapeByMrid.value(QStringLiteral("equivalent-001"))) != nullptr);
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:DiagramObjectPoint rdf:ID="diagram-equivalent-layout-001-p1">
    ...
    auto* generator =
        dynamic_cast<LzPowerGeneratorItem*>(buildResult.shapeByMrid.value(QStringLiteral("generator-layout-001")));
    auto* external =
        dynamic_cast<LzPowerGridItem*>(buildResult.shapeByMrid.value(QStringLiteral("external-layout-001")));
    auto* equivalent =
        dynamic_cast<LzPowerGridItem*>(buildResult.shapeByMrid.value(QStringLiteral("equivalent-layout-001")));
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:Terminal rdf:ID="terminal-grid-default-002">
    ...
    auto* generator =
        dynamic_cast<LzPowerGeneratorItem*>(buildResult.shapeByMrid.value(QStringLiteral("generator-default-001")));
    auto* grid =
        dynamic_cast<LzPowerGridItem*>(buildResult.shapeByMrid.value(QStringLiteral("grid-default-001")));
    auto* load =
        dynamic_cast<LzPowerLoadItem*>(buildResult.shapeByMrid.value(QStringLiteral("load-default-001")));
    ...
    QList<LzConnectLine*> helperLines;
    for (QGraphicsItem* item : scene.items())
    {
        auto* line = qgraphicsitem_cast<LzConnectLine*>(item);
        if (line && line->data(CimSceneBuilder::CimGeneratedVisualHelperDataKey).toBool())
    ...
    LzConnectLine* generatorToGrid = nullptr;
    LzConnectLine* gridToLoad = nullptr;
    for (LzConnectLine* line : helperLines)
    {
    ...
    LzConnectPoint* generatorPort = linePortOnItem(generatorToGrid, generator);
    LzConnectPoint* gridPortToGenerator = linePortOnItem(generatorToGrid, grid);
    LzConnectPoint* gridPortToLoad = linePortOnItem(gridToLoad, grid);
    LzConnectPoint* loadPort = linePortOnItem(gridToLoad, load);
...
void TestCimGraphics::importer_and_scene_builder_materialize_reference_source_and_load_graphics()
{
    ...
    auto* grid = dynamic_cast<LzPowerGridItem*>(buildResult.shapeByMrid.value(QStringLiteral("HV-Netz")));
    auto* load = dynamic_cast<LzPowerLoadItem*>(buildResult.shapeByMrid.value(QStringLiteral("Load7-I")));

    QVERIFY(grid != nullptr);
    QVERIFY(load != nullptr);
    QCOMPARE(grid->drawTypeForXml(), LZ_WSYM_GRID);
    QCOMPARE(load->drawTypeForXml(), LZ_SLD_LOAD);
    ...
    {
        QVERIFY2(dynamic_cast<LzPowerLoadItem*>(publicBuildResult.shapeByMrid.value(object.mrid)) != nullptr,
    ...
    {
        QVERIFY2(dynamic_cast<LzPowerGridItem*>(publicBuildResult.shapeByMrid.value(object.mrid)) != nullptr,
                 qPrintable(QStringLiteral("ExternalNetworkInjection 未落成电网图元: %1").arg(object.mrid)));
    }

    auto* publicGrid =
        dynamic_cast<LzPowerGridItem*>(publicBuildResult.shapeByMrid.value(QStringLiteral("HV-Netz")));
    auto* publicLoad =
        dynamic_cast<LzPowerLoadItem*>(publicBuildResult.shapeByMrid.value(QStringLiteral("Load7-I")));

    QVERIFY(publicGrid != nullptr);
    QVERIFY(publicLoad != nullptr);
    QCOMPARE(publicGrid->drawTypeForXml(), LZ_WSYM_GRID);
    QCOMPARE(publicLoad->drawTypeForXml(), LZ_SLD_LOAD);
...
void TestCimGraphics::importer_and_scene_builder_materialize_junction_graphics()
{
    ...
    auto* junction = dynamic_cast<LzPowerJunctionItem*>(buildResult.shapeByMrid.value(QStringLiteral("junction-001")));
    auto* breakerA = dynamic_cast<LzPowerCircuitBreakerItem*>(buildResult.shapeByMrid.value(QStringLiteral("breaker-a")));
    auto* breakerB = dynamic_cast<LzPowerCircuitBreakerItem*>(buildResult.shapeByMrid.value(QStringLiteral("breaker-b")));

    QVERIFY(junction != nullptr);
    QVERIFY(breakerA != nullptr);
    QVERIFY(breakerB != nullptr);
    QCOMPARE(junction->drawTypeForXml(), LZ_WSYM_JUNCTION);
...
void TestCimGraphics::importer_and_scene_builder_materialize_medium_sample_junction_graphics()
{
    ...
    {
        auto* junction = dynamic_cast<LzPowerJunctionItem*>(buildResult.shapeByMrid.value(mrid));
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:DiagramObjectPoint rdf:ID="diagram-load-plain-001-p1">
    ...
    auto* autoXfmr =
        dynamic_cast<LzPowerAutoXfmrItem*>(buildResult.shapeByMrid.value(QStringLiteral("xfmr-auto-001")));
    auto* earthingXfmr =
        dynamic_cast<LzPowerEarthingXfmrItem*>(buildResult.shapeByMrid.value(QStringLiteral("xfmr-earthing-001")));
    auto* autoGenerator =
        dynamic_cast<LzPowerGeneratorItem*>(buildResult.shapeByMrid.value(QStringLiteral("gen-auto-001")));
    auto* autoLoad =
        dynamic_cast<LzPowerLoadItem*>(buildResult.shapeByMrid.value(QStringLiteral("load-auto-001")));
    auto* plainGenerator =
        dynamic_cast<LzPowerGeneratorItem*>(buildResult.shapeByMrid.value(QStringLiteral("gen-plain-001")));
    auto* plainLoad =
        dynamic_cast<LzPowerLoadItem*>(buildResult.shapeByMrid.value(QStringLiteral("load-plain-001")));
    auto* plainXfmr =
        dynamic_cast<LzPowerTransformer2wItem*>(buildResult.shapeByMrid.value(QStringLiteral("xfmr-plain-001")));
    auto* stationXfmr =
        dynamic_cast<LzPowerStationXfmrItem*>(buildResult.shapeByMrid.value(QStringLiteral("xfmr-station-001")));
    ...
    LzConnectLine* autoGeneratorLine = findGeneratedHelperLineBetween(scene, autoXfmr, autoGenerator);
    LzConnectLine* autoLoadLine = findGeneratedHelperLineBetween(scene, autoXfmr, autoLoad);
    LzConnectLine* plainGeneratorLine = findGeneratedHelperLineBetween(scene, plainXfmr, plainGenerator);
    LzConnectLine* plainLoadLine = findGeneratedHelperLineBetween(scene, plainXfmr, plainLoad);
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:DiagramObjectPoint rdf:ID="diagram-load-plain-001-p1">
    ...
    auto* rotatedAutoXfmr =
        dynamic_cast<LzPowerAutoXfmrItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("xfmr-auto-001")));
    auto* rotatedStationXfmr =
        dynamic_cast<LzPowerStationXfmrItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("xfmr-station-001")));
    auto* rotatedEarthingXfmr =
        dynamic_cast<LzPowerEarthingXfmrItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("xfmr-earthing-001")));
    auto* rotatedPlainXfmr =
        dynamic_cast<LzPowerTransformer2wItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("xfmr-plain-001")));
    auto* rotatedAutoGenerator =
        dynamic_cast<LzPowerGeneratorItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("gen-auto-001")));
    auto* rotatedAutoLoad =
        dynamic_cast<LzPowerLoadItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("load-auto-001")));
    auto* rotatedStationGenerator =
        dynamic_cast<LzPowerGeneratorItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("gen-station-001")));
    auto* rotatedStationLoad =
        dynamic_cast<LzPowerLoadItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("load-station-001")));
    auto* rotatedEarthingGenerator =
        dynamic_cast<LzPowerGeneratorItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("gen-earthing-001")));
    auto* rotatedEarthingLoad =
        dynamic_cast<LzPowerLoadItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("load-earthing-001")));
    auto* rotatedPlainGenerator =
        dynamic_cast<LzPowerGeneratorItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("gen-plain-001")));
    auto* rotatedPlainLoad =
        dynamic_cast<LzPowerLoadItem*>(rotatedBuildResult.shapeByMrid.value(QStringLiteral("load-plain-001")));
...
void TestCimGraphics::importer_and_scene_builder_materialize_transformer_3w_graphics()
{
    ...
    CimGraphicMapper mapper;
    QCOMPARE(mapper.drawTypeForObject(*transformer), LZ_WSYM_TRANSFORMER_3W);

    LzScene scene;
    CimSceneBuilder builder;
    const CimSceneBuilder::BuildResult buildResult = builder.populateSceneFromCimModel(&scene, importResult.model);

    auto* transformer3w = dynamic_cast<LzPowerTransformer3wItem*>(buildResult.shapeByMrid.value(QStringLiteral("xfmr-3w-001")));
    QVERIFY(transformer3w != nullptr);
    QCOMPARE(transformer3w->drawTypeForXml(), LZ_WSYM_TRANSFORMER_3W);
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:DiagramObjectPoint rdf:ID="diagram-grid-3w-conflict-001-p1">
    ...
    auto* conflictTransformer =
        dynamic_cast<LzPowerTransformer3wItem*>(conflictBuildResult.shapeByMrid.value(QStringLiteral("xfmr-3w-conflict-001")));
    auto* conflictGenerator =
        dynamic_cast<LzPowerGeneratorItem*>(conflictBuildResult.shapeByMrid.value(QStringLiteral("gen-3w-conflict-001")));
    auto* conflictLoad =
        dynamic_cast<LzPowerLoadItem*>(conflictBuildResult.shapeByMrid.value(QStringLiteral("load-3w-conflict-001")));
    auto* conflictGrid =
        dynamic_cast<LzPowerGridItem*>(conflictBuildResult.shapeByMrid.value(QStringLiteral("grid-3w-conflict-001")));
    ...
    LzConnectLine* generatorLine = findGeneratedHelperLineBetween(conflictScene, conflictTransformer, conflictGenerator);
    LzConnectLine* loadLine = findGeneratedHelperLineBetween(conflictScene, conflictTransformer, conflictLoad);
    LzConnectLine* gridLine = findGeneratedHelperLineBetween(conflictScene, conflictTransformer, conflictGrid);
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:DiagramObjectPoint rdf:ID="diagram-grid-3w-conflict-001-p1">
    ...
    auto* rotatedConflictTransformer =
        dynamic_cast<LzPowerTransformer3wItem*>(rotatedConflictBuildResult.shapeByMrid.value(QStringLiteral("xfmr-3w-conflict-001")));
    auto* rotatedConflictGenerator =
        dynamic_cast<LzPowerGeneratorItem*>(rotatedConflictBuildResult.shapeByMrid.value(QStringLiteral("gen-3w-conflict-001")));
    auto* rotatedConflictLoad =
        dynamic_cast<LzPowerLoadItem*>(rotatedConflictBuildResult.shapeByMrid.value(QStringLiteral("load-3w-conflict-001")));
    auto* rotatedConflictGrid =
        dynamic_cast<LzPowerGridItem*>(rotatedConflictBuildResult.shapeByMrid.value(QStringLiteral("grid-3w-conflict-001")));
...
void TestCimGraphics::importer_and_scene_builder_preserve_transformer_3w_layout_when_diagram_data_exists()
{
    ...
    auto* transformer3w =
        dynamic_cast<LzPowerTransformer3wItem*>(buildResult.shapeByMrid.value(QStringLiteral("xfmr-3w-layout-001")));
    QVERIFY(transformer3w != nullptr);
    QCOMPARE(transformer3w->drawTypeForXml(), LZ_WSYM_TRANSFORMER_3W);
...
void TestCimGraphics::importer_and_scene_builder_materialize_shunt_compensator_family_graphics()
{
    ...
    QVERIFY(dynamic_cast<LzPowerCapacitorItem*>(buildResult.shapeByMrid.value(QStringLiteral("cap-bank-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerReactorItem*>(buildResult.shapeByMrid.value(QStringLiteral("reactor-bank-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerSplitReactorItem*>(buildResult.shapeByMrid.value(QStringLiteral("split-reactor-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerReactorItem*>(buildResult.shapeByMrid.value(QStringLiteral("nonlinear-reactor-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerSvgCompItem*>(buildResult.shapeByMrid.value(QStringLiteral("svg-comp-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerArcCoilItem*>(buildResult.shapeByMrid.value(QStringLiteral("arc-coil-001"))) != nullptr);
}
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:DiagramObjectPoint rdf:ID="diagram-arc-layout-001-p1">
    ...
    auto* capacitor =
        dynamic_cast<LzPowerCapacitorItem*>(buildResult.shapeByMrid.value(QStringLiteral("cap-layout-001")));
    auto* reactor =
        dynamic_cast<LzPowerReactorItem*>(buildResult.shapeByMrid.value(QStringLiteral("reactor-layout-001")));
    auto* splitReactor =
        dynamic_cast<LzPowerSplitReactorItem*>(buildResult.shapeByMrid.value(QStringLiteral("split-layout-001")));
    auto* svg =
        dynamic_cast<LzPowerSvgCompItem*>(buildResult.shapeByMrid.value(QStringLiteral("svg-layout-001")));
    auto* arcCoil =
        dynamic_cast<LzPowerArcCoilItem*>(buildResult.shapeByMrid.value(QStringLiteral("arc-layout-001")));
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:Terminal rdf:ID="terminal-series-reactor-001">
    ...
    QVERIFY(dynamic_cast<LzPowerCapacitorItem*>(buildResult.shapeByMrid.value(QStringLiteral("series-cap-001"))) != nullptr);
    QVERIFY(dynamic_cast<LzPowerReactorItem*>(buildResult.shapeByMrid.value(QStringLiteral("series-reactor-001"))) != nullptr);
}
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <cim:DiagramObjectPoint rdf:ID="diagram-series-reactor-layout-001-p1">
    ...
    auto* capacitor =
        dynamic_cast<LzPowerCapacitorItem*>(buildResult.shapeByMrid.value(QStringLiteral("series-cap-layout-001")));
    auto* reactor =
        dynamic_cast<LzPowerReactorItem*>(buildResult.shapeByMrid.value(QStringLiteral("series-reactor-layout-001")));
...
void TestCimGraphics::terminal_connectivity_and_topological_nodes_remain_non_visual()
{
    ...
    QVERIFY(dynamic_cast<LzPowerCircuitBreakerItem*>(buildResult.shapeByMrid.value(QStringLiteral("breaker-001"))) != nullptr);
