#ifndef CIMDRAWCONNECTPOINT_H
#define CIMDRAWCONNECTPOINT_H
...
class CimdrawConnectPoint : public QGraphicsItem
{
public:
    CimdrawConnectPoint(QGraphicsItem* parent);
    ~CimdrawConnectPoint();
...
private:
    QScopedPointer<CimdrawConnectPointPrivate> d_ptr;
};

namespace ConnectPoint
{
    typedef QVector<CimdrawConnectPoint*> Points;
    struct ConnectPoint
    {
