...
public:
    explicit LzArc(QGraphicsItem* parent = nullptr);
    LzArc(const QRectF& pos,QGraphicsItem* parent = nullptr);
...
protected:
    Q_DECLARE_PRIVATE(LzArc);
    QScopedPointer<LzArcPrivate> d_ptr;
};
