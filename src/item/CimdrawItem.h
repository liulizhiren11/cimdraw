#ifndef CIMDRAWITEM_H
#define CIMDRAWITEM_H

#include "TmpBase.h"
#include <QGraphicsItem>

class CimdrawItem : public QObject, public TmpBase<QGraphicsItem>
{
    Q_OBJECT
    // 定义新属性的 Q_PROPERTY
...
public:
    ...
    explicit CimdrawItem(QGraphicsItem* parent = nullptr);
    CimdrawItem(const QRectF& pos, QGraphicsItem* parent = nullptr);
