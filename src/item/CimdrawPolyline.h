#ifndef CIMDRAWPOLYLINE_H
#define CIMDRAWPOLYLINE_H
...
class CimdrawPolyline : public CimdrawItem
{
public:
    explicit CimdrawPolyline(QGraphicsItem* item = nullptr);

    CimdrawPolyline(const QRectF& pos,QGraphicsItem* parent = nullptr);
...
protected:
    Q_DECLARE_PRIVATE(CimdrawPolyline);
    QScopedPointer<CimdrawPolylinePrivate> d_ptr;
};
