...
CimdrawImageWidget::CimdrawImageWidget(QWidget* parent)
{
...
void CimdrawImageWidget::contextMenuEvent(QContextMenuEvent *event)
{
...
void CimdrawImageWidget::addImage()
{
...
void CimdrawImageWidget::deleteSelectedItem(QListWidgetItem* item)
{
    if (item)
    {
