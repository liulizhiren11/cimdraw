...
FrameWorkspaceBuilder::WiringToolbarResult FrameWorkspaceBuilder::createWiringToolbar(QMainWindow* host) const
{
    ...
    const struct { LzWiringSymbolStandard value; } options[] = {
        {LzWiringSymbolStandard::GB},
        {LzWiringSymbolStandard::IEC},
        {LzWiringSymbolStandard::ANSI},
    };
    for (const auto& opt : options)
    {
        result.standardCombo->addItem(LzAppConfig::symbolStandardDisplayName(opt.value),
