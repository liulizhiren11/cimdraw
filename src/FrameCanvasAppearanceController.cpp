...
LzView* FrameCanvasAppearanceController::currentView(QTabWidget* tabs) const
{
    if (!tabs)
        return nullptr;
...
bool FrameCanvasAppearanceController::applyBackgroundColor(LzView* view,
                                                           QPushButton* button,
...
bool FrameCanvasAppearanceController::applyBackgroundImage(LzView* view, const QString& imagePath) const
{
                                                                          ...
                                                                          QPushButton* button) const
{
    ...
    if (LzView* view = currentView(tabs))
    {
