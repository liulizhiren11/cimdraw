#ifndef CIMDRAWVIEW_H
#define CIMDRAWVIEW_H
...
class CimdrawView : public QGraphicsView
{
    Q_OBJECT
public:
    CimdrawView(QWidget* parent = nullptr);

    ~CimdrawView();

    virtual CimdrawScene* getScene();

    virtual void setPowerScene(CimdrawScene* scene);
...
protected:
    Q_DECLARE_PRIVATE(CimdrawView);
    QScopedPointer<CimdrawViewPrivate> d_ptr;
