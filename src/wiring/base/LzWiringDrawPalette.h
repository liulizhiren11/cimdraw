#ifndef LZWIRINGDRAWPALETTE_H
#define LZWIRINGDRAWPALETTE_H
 ...
 * 母线使用偏黄铜色调。
 */
namespace LzWiringDrawPalette {

inline QColor conductorStroke(LzWiringRunState s)
{
    switch (s)
    {
    case LzWiringRunState::Energized:
        return QColor(0, 142, 82);
    case LzWiringRunState::Deenergized:
        return QColor(118, 128, 148);
    case LzWiringRunState::Alarm:
...
inline QColor alarm()
{
    return conductorStroke(LzWiringRunState::Alarm);
}

inline QColor busbarFill(LzWiringRunState s, bool alarmPulse)
{
    switch (s)
    {
    case LzWiringRunState::Energized:
...
{
    return conductorStroke(LzWiringRunState::Normal);
}
...
inline QColor cableZigAccent(LzWiringRunState s)
{
    switch (s)
    {
    case LzWiringRunState::Alarm:
...
inline QColor capacitorPlate(LzWiringRunState s)
{
    switch (s)
    {
    case LzWiringRunState::Alarm:
...
inline QColor reactorCoil(LzWiringRunState s)
{
    switch (s)
    {
    case LzWiringRunState::Alarm:
...
} // 接线图配色命名空间 LzWiringDrawPalette

#endif // LZWIRINGDRAWPALETTE_H
