#ifndef CIMDRAWPOWERGENERATORTOOL_H
#define CIMDRAWPOWERGENERATORTOOL_H

#include "Tool/CimdrawTool.h"

class CimdrawScene;

class CimdrawPowerGeneratorTool : public CimdrawTool
{
    Q_OBJECT
public:
    explicit CimdrawPowerGeneratorTool(QObject* parent = nullptr);
    ~CimdrawPowerGeneratorTool() override;
...
#endif // CIMDRAWPOWERGENERATORTOOL_H
