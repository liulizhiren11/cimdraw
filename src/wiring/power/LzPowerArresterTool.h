#ifndef LZPOWERARRESTERTOOL_H
#define LZPOWERARRESTERTOOL_H

#include "Tool/LzTool.h"

class LzScene;

class LzPowerArresterTool : public LzTool
{
    Q_OBJECT
public:
    explicit LzPowerArresterTool(QObject* parent = nullptr);
    ~LzPowerArresterTool() override;
