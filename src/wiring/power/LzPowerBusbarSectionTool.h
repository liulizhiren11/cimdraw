#ifndef LZPOWERBUSBARSECTIONTOOL_H
#define LZPOWERBUSBARSECTIONTOOL_H

#include "Tool/LzTool.h"

class LzScene;

class LzPowerBusbarSectionTool : public LzTool
{
    Q_OBJECT
public:
    explicit LzPowerBusbarSectionTool(QObject* parent = nullptr);
    ~LzPowerBusbarSectionTool() override;
...
#endif // LZPOWERBUSBARSECTIONTOOL_H
