#ifndef LZPOWERMOTORTOOL_H
#define LZPOWERMOTORTOOL_H

#include "Tool/LzTool.h"

class LzScene;

class LzPowerMotorTool : public LzTool
{
    Q_OBJECT
public:
    explicit LzPowerMotorTool(QObject* parent = nullptr);
    ~LzPowerMotorTool() override;
