#ifndef CIMDRAWPOWERGROUNDTOOL_H
#define CIMDRAWPOWERGROUNDTOOL_H

#include "Tool/CimdrawTool.h"

class CimdrawScene;

class CimdrawPowerGroundTool : public CimdrawTool
{
    Q_OBJECT
public:
    explicit CimdrawPowerGroundTool(QObject* parent = nullptr);
    ~CimdrawPowerGroundTool() override;
...
#endif // CIMDRAWPOWERGROUNDTOOL_H
