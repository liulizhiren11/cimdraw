#ifndef CIMDRAWPOWEREARTHINGXFMRTOOL_H
#define CIMDRAWPOWEREARTHINGXFMRTOOL_H

#include "Tool/CimdrawTool.h"

class CimdrawScene;

class CimdrawPowerEarthingXfmrTool : public CimdrawTool
{
    Q_OBJECT
public:
    explicit CimdrawPowerEarthingXfmrTool(QObject* parent = nullptr);
    ~CimdrawPowerEarthingXfmrTool() override;
...
#endif // CIMDRAWPOWEREARTHINGXFMRTOOL_H
