#ifndef CIMDRAWPOWERARRESTERTOOL_H
#define CIMDRAWPOWERARRESTERTOOL_H

#include "Tool/CimdrawTool.h"

class CimdrawScene;

class CimdrawPowerArresterTool : public CimdrawTool
{
    Q_OBJECT
public:
    explicit CimdrawPowerArresterTool(QObject* parent = nullptr);
    ~CimdrawPowerArresterTool() override;
...
#endif // CIMDRAWPOWERARRESTERTOOL_H
