#ifndef LZPOWERGRIDITEM_H
#define LZPOWERGRIDITEM_H

#include "LzWiringItemBase.h"

class LzPowerGridItem : public LzWiringItemBase
{
    Q_OBJECT
public:
    explicit LzPowerGridItem(QGraphicsItem* parent = nullptr);
    explicit LzPowerGridItem(const QRectF& pos, QGraphicsItem* parent = nullptr);
