#ifndef CIMDRAWPOWERJUNCTIONTOOL_H
#define CIMDRAWPOWERJUNCTIONTOOL_H

#include "Tool/CimdrawTool.h"

class CimdrawScene;

class CimdrawPowerJunctionTool : public CimdrawTool
{
    Q_OBJECT
public:
    explicit CimdrawPowerJunctionTool(QObject* parent = nullptr);
    ~CimdrawPowerJunctionTool() override;
...
#endif // CIMDRAWPOWERJUNCTIONTOOL_H
