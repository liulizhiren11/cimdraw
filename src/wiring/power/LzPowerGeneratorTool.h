#ifndef LZPOWERGENERATORTOOL_H
#define LZPOWERGENERATORTOOL_H

#include "Tool/LzTool.h"

class LzScene;

class LzPowerGeneratorTool : public LzTool
{
    Q_OBJECT
public:
    explicit LzPowerGeneratorTool(QObject* parent = nullptr);
    ~LzPowerGeneratorTool() override;
