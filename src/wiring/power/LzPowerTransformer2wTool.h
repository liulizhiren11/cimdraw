#ifndef LZPOWERTRANSFORMER2WTOOL_H
#define LZPOWERTRANSFORMER2WTOOL_H

#include "Tool/LzTool.h"

class LzScene;

class LzPowerTransformer2wTool : public LzTool
{
    Q_OBJECT
public:
    explicit LzPowerTransformer2wTool(QObject* parent = nullptr);
    ~LzPowerTransformer2wTool() override;
...
#endif // LZPOWERTRANSFORMER2WTOOL_H
