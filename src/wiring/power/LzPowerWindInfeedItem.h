#ifndef LZPOWERWINDINFEEDITEM_H
#define LZPOWERWINDINFEEDITEM_H

#include "LzWiringItemBase.h"

class LzPowerWindInfeedItem : public LzWiringItemBase
{
    Q_OBJECT
public:
    explicit LzPowerWindInfeedItem(QGraphicsItem* parent = nullptr);
    explicit LzPowerWindInfeedItem(const QRectF& pos, QGraphicsItem* parent = nullptr);
