...
FrameActionBuilder::FileActionsResult FrameActionBuilder::installFileActions(QMainWindow* host, CimdrawFrame* frame) const
{
    ...
    QAction* fileNewAction = createAction(host,
        ...
        QObject::tr("新建 CIMDraw"));
    QObject::connect(fileNewAction, &QAction::triggered, frame, &CimdrawFrame::newPowerScene);
    ...
    QAction* fileNewPowerAction = createAction(host,
        ...
        QKeySequence(),
        QObject::tr("新建 CIMDraw"));
    QObject::connect(fileNewPowerAction, &QAction::triggered, frame, &CimdrawFrame::newPowerScene);
    ...
    QAction* fileOpenAction = createAction(host,
        ...
        QObject::tr("打开"));
    QObject::connect(fileOpenAction, &QAction::triggered, frame, &CimdrawFrame::onFileOpen);
    ...
    QObject::connect(importCimAction, &QAction::triggered, frame, &CimdrawFrame::onImportCimCgmes);
    ...
    result.actionFileSave = createAction(host,
        ...
        QObject::tr("保存"));
    QObject::connect(result.actionFileSave, &QAction::triggered, frame, &CimdrawFrame::onFileSave);
    ...
    result.actionFileSaveAs = createAction(host,
        ...
        QObject::tr("另存为"));
    QObject::connect(result.actionFileSaveAs, &QAction::triggered, frame, &CimdrawFrame::onFileSaveAs);
...
FrameActionBuilder::EditActionsResult FrameActionBuilder::installEditActions(QMainWindow* host, CimdrawFrame* frame) const
{
    ...
    QAction* actionEditCut = createAction(host,
        ...
        QObject::tr("剪切"));
    QObject::connect(actionEditCut, &QAction::triggered, frame, &CimdrawFrame::editCut);
    ...
    QAction* actionEditCopy = createAction(host,
        ...
        QObject::tr("复制"));
    QObject::connect(actionEditCopy, &QAction::triggered, frame, &CimdrawFrame::editCopy);
    ...
    QAction* actionEditPaste = createAction(host,
        ...
        QObject::tr("粘贴"));
    QObject::connect(actionEditPaste, &QAction::triggered, frame, &CimdrawFrame::editPaste);
    ...
    result.actionEditUndo = createAction(host,
        ...
        QKeySequence::Undo,
        QObject::tr("撤销"));
    QObject::connect(result.actionEditUndo, &QAction::triggered, frame, &CimdrawFrame::onEditUndo);

    QAction* actionDelete = createAction(host,
        QObject::tr("删除"),
        QStringLiteral(":/image/edit_delete.png"),
        QKeySequence(QObject::tr("Delete")));
    QObject::connect(actionDelete, &QAction::triggered, frame, &CimdrawFrame::onDeleteItem);
    ...
    result.actionEditRedo = createAction(host,
        ...
        QKeySequence::Redo,
        QObject::tr("还原"));
    QObject::connect(result.actionEditRedo, &QAction::triggered, frame, &CimdrawFrame::onEditRedo);
    ...
    QAction* actionGroup = createAction(host,
        ...
        QKeySequence(),
        QObject::tr("分组"));
    QObject::connect(actionGroup, &QAction::triggered, frame, &CimdrawFrame::onEditGroup);
    ...
    QAction* actionUnGroup = createAction(host,
        ...
        QKeySequence(),
        QObject::tr("取消分组"));
    QObject::connect(actionUnGroup, &QAction::triggered, frame, &CimdrawFrame::onEditUnGroup);
...
void FrameActionBuilder::installViewActions(QMainWindow* host, CimdrawFrame* frame) const
{
    if (!host || !frame)
        return;
    ...
    QAction* normalViewAction = createAction(host,
        ...
        QObject::tr("实际大小"));
    QObject::connect(normalViewAction, &QAction::triggered, frame, &CimdrawFrame::onNormalView);
    ...
    QAction* bestfitViewAction = createAction(host,
        ...
        QObject::tr("适合大小"));
    QObject::connect(bestfitViewAction, &QAction::triggered, frame, &CimdrawFrame::onBestfitView);
    ...
    QAction* zoomInViewAction = createAction(host,
        ...
        QObject::tr("放大"));
    QObject::connect(zoomInViewAction, &QAction::triggered, frame, &CimdrawFrame::onZoomIn);
    ...
    QAction* zoomOutViewAction = createAction(host,
        ...
        QObject::tr("缩小"));
    QObject::connect(zoomOutViewAction, &QAction::triggered, frame, &CimdrawFrame::onZoomOut);
    ...
    QAction* resetZoomAction = createAction(host,
        ...
        QObject::tr("重置缩放"));
    QObject::connect(resetZoomAction, &QAction::triggered, frame, &CimdrawFrame::onZoomReset);
...
void FrameActionBuilder::installTopologyActions(QMainWindow* host, CimdrawFrame* frame) const
{
    if (!host || !frame)
        return;
    ...
    QObject::connect(generateAction, &QAction::triggered, frame, &CimdrawFrame::onGenerateTopologyGraph);

    QAction* generatePowerAction = createAction(host, QObject::tr("生成电力拓扑图"));
    QObject::connect(generatePowerAction, &QAction::triggered, frame, &CimdrawFrame::onGeneratePowerTopologyGraph);

    QAction* summaryAction = createAction(host, QObject::tr("当前选中图元拓扑摘要"));
    QObject::connect(summaryAction, &QAction::triggered, frame, &CimdrawFrame::onShowTopologySummary);

    QAction* highlightAction = createAction(host, QObject::tr("高亮当前选中图元相关拓扑"));
    QObject::connect(highlightAction, &QAction::triggered, frame, &CimdrawFrame::onHighlightSelectedTopology);

    QAction* clearHighlightAction = createAction(host, QObject::tr("清除拓扑高亮"));
    QObject::connect(clearHighlightAction, &QAction::triggered, frame, &CimdrawFrame::onClearTopologyHighlights);
...
void FrameActionBuilder::installAlignActions(QMainWindow* host, CimdrawFrame* frame) const
{
    if (!host || !frame)
        return;
...
void FrameActionBuilder::installHelpMenu(QMainWindow* host, CimdrawFrame* frame) const
{
    if (!host || !frame)
        return;
    ...
    QObject::connect(aboutAction, &QAction::triggered, frame, &CimdrawFrame::about);
