#ifndef CIMDRAWSNOWFLAKEID_H
#define CIMDRAWSNOWFLAKEID_H
 ...
 */
class CimdrawSnowflakeId
{
public:
    static CimdrawSnowflakeId& instance();
...
private:
    CimdrawSnowflakeId() = default;
    CimdrawSnowflakeId(const CimdrawSnowflakeId&) = delete;
    CimdrawSnowflakeId& operator=(const CimdrawSnowflakeId&) = delete;
