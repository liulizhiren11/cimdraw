#ifndef LZCONNECTORALGORITHM_H
#define LZCONNECTORALGORITHM_H
 ...
 * 提供：路径点插入投影、正交拐点约束、正交路径规划等，与 LzAStar 配合使用
 */
class LzConnectorAlgorithm
{
public:
