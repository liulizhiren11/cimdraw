...
LzSnowflakeId& LzSnowflakeId::instance()
{
    static LzSnowflakeId s_inst;
    return s_inst;
}

void LzSnowflakeId::configure(quint16 workerId)
{
    QMutexLocker locker(&m_mutex);
    m_workerId = workerId;
}

QString LzSnowflakeId::nextIdString()
{
    QMutexLocker locker(&m_mutex);
