...
FrameDockBuilder::DrawItemsDockResult FrameDockBuilder::createDrawItemsDock(QMainWindow* host, CimdrawFrame* frame) const
{
    ...
    result.toolBox = new CimdrawToolBoxManager(frame);
...
FrameDockBuilder::PropertyDockResult FrameDockBuilder::createPropertyDock(QMainWindow* host, CimdrawFrame* frame) const
{
    ...
    result.controller = new CimdrawItemController(frame);
