#ifndef CIMDRAWFRAMW_H
#define CIMDRAWFRAMW_H
...
class CimdrawFrame :public QMainWindow
{
    Q_OBJECT
public:
    CimdrawFrame(QString filePath = QString(),QWidget* parent=nullptr);
    ~CimdrawFrame();
...
private:
    ...
    Q_DECLARE_PRIVATE(CimdrawFrame);
    QScopedPointer<CimdrawFramePrivate> d_ptr;
};
#endif
